...
function SvgPathDrawingTextAnimation({
  ...
  return (
    <div
      className={cn(
        "flex min-h-[160px] sm:min-h-[200px] w-full items-center justify-center overflow-hidden px-2",
        className,
      )}
    >
      <svg
...
export type PathDrawingPortfolioHeroProps = {
  ...
  /** Gradient end color */
  toColor?: string;
  /** Duration in seconds for one draw pass */
  durationSec?: number;
...
export default function PathDrawingPortfolioHero({
  ...
  return (
    ...
    >
      <div className="relative z-10 flex w-full max-w-6xl flex-col items-center px-4 pb-6 pt-10 text-center sm:px-10 sm:pb-12 sm:pt-20">
        {eyebrow ? (
          <motion.p
            className="mb-4 text-[0.65rem] font-medium uppercase tracking-[0.25em] text-white/60 sm:mb-8 sm:text-xs sm:tracking-[0.35em]"
